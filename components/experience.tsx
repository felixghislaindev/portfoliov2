...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      techStack: ["AngularJS", "Vue.js", "JavaScript", "KendoUI", "Node.js", "Express"],
    },
  ]
  ...
  return (
    <section id="experience" className="py-12 md:py-16 border-t border-border/40">
      ...
      <div className="space-y-6 md:space-y-8 px-4">
        {experiences.map((exp) => (
          <Card key={exp.company} className="overflow-hidden border-primary/10 bg-card/50 backdrop-blur-sm">
            <CardHeader className="pb-2 px-4 md:px-6 pt-4 md:pt-6">
              <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2">
                ...
                <Badge variant="outline" className="w-fit md:text-sm font-medium">
                  {exp.period}
                </Badge>
              </div>
            </CardHeader>
